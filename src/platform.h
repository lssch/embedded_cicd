...
#define PL_CONFIG_USE_PICO_W            (1) /* if using Pico W board */
   ...
   */
#define PL_CONFIG_USE_UNIT_TESTS        (1 && defined(ENABLE_UNIT_TESTS) && ENABLE_UNIT_TESTS==1)  // TODO: use for unit tests
...
#define PL_CONFIG_USE_GCOV              (1 && McuRdimon_CONFIG_IS_ENABLED) // TODO: use gcov if
